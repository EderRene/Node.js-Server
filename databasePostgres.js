...
const queryStringSelectAllNews = "SELECT n.id_News, n.id_Employee, e.forename, e.surname, TO_CHAR(n.dateTime, 'DD.MM.YYYY/HH24:MI') AS dateTime, n.infoHeader, n.info FROM news n INNER JOIN employee e ON n.id_Employee=e.id_Employee";
